/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv` (hash: a65816f177275630bd7c8f5c69b4e34f)
// Runtime types generated with workerd@1.20251109.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EvaluationScheduler";
	}
	interface Env {
		CACHE: KVNamespace;
		EVALUATION_SCHEDULAR: DurableObjectNamespace /* EvaluationScheduler */;
		BUCKET: R2Bucket;
		DB: D1Database;
		QUEUE: Queue;
