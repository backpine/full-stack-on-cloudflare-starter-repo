/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv` (hash: 5167f08213ed31a5e1edc967d8d5eaad)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		DESINATION_EVALUATION_WORKFLOW: Workflow<Parameters<import("./src/index").DestinationEvaluationWorkflow['run']>[0]['payload']>;
	}
}
